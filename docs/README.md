...
- [`diagrams/`](diagrams/) — the architecture figures: three layered views (platform, analyst loop, query routing) and five [C4](https://c4model.com/) views (context, containers, and components for the application, data plane and agent runtime), all generated by [`../scripts/dev/gen_architecture_diagrams.py`](../scripts/dev/gen_architecture_diagrams.py)
