...
- Create: `migrations/versions/0115_issue_reports.py`
...
Check the head first: `ls migrations/versions | tail -3` — if a `0114_*` already exists, take the next number and revise the newest head. `migrations/versions/0115_issue_reports.py`:
...
Revision ID: 0115_issue_reports
...
```bash
git add src/models/issue_reports.py src/models/__init__.py migrations/versions/0115_issue_reports.py \
