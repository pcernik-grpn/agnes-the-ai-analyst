...
class LLMDetector:
    ...
    def _create(self, chunk: str) -> Any:
        ...
        # ONE record for the pair below: the temperature-retry re-sends the
        # SAME logical detection with one keyword dropped, and recording it
        # twice would double-count a chunk's cost — see the class docstring.
        with (
