...
Mirrors DuckDB ``_v123_to_v124``. Data-only: no column change.
...
raising, the same defensive posture ``_v123_to_v124`` needs for a DuckDB
install replaying the ladder from far enough back that ``sync_state``
predates its modern columns.

Revision ID: 0072_sync_state_id_v124
Revises: 0071_chat_message_parts_v123
...
revision: str = "0072_sync_state_id_v124"
down_revision: Union[str, None] = "0071_chat_message_parts_v123"
