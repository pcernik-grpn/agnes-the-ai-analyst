...
When the thing the user asked for **is a file** — a `.docx`, a `.pptx`, an
`.xlsx`, a PDF, a CSV export — write it to **`outputs/`**, relative to your
working directory. Create the directory if it isn't there.
