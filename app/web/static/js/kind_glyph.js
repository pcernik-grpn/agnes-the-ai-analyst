...
(function () {
  ...
  memory: '<svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="4.5" y="3.5" width="15" height="17" rx="2.5" stroke="currentColor" stroke-width="1.6"/><path d="M9.9 3.5v8.5l2.1-1.8 2.1 1.8v-8.5" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/></svg>',
