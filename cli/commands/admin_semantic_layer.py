...
(``agnes semantic-model coverage`` and ``… coverage tables``), while this one
...
deprecated_alias(
    admin_semantic_layer_app,
    name="coverage",
    old="admin semantic-layer coverage",
    new="admin semantic keboola-import",
    fn=admin_semantic.keboola_import,
)
